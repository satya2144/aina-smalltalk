...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../GoogleWebRTC/1.1.m89.a1/Release/WebRTC.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_apns/flutter_apns.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_callkit_voximplant/flutter_callkit_voximplant.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_reactive_ble/flutter_reactive_ble.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/qr_code_tools/qr_code_tools.framework"
